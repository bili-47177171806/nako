...
```bash
# Fork 仓库后克隆到本地
git clone https://github.com/your-username/nako.git
cd nako

# 添加上游仓库
git remote add upstream https://github.com/25-ji-code-de/nako.git
```
...
- 浏览现有的 [Issues](https://github.com/25-ji-code-de/nako/issues)
- 在 Issue 中提问
- 查看其他 SEKAI 生态项目的实现
